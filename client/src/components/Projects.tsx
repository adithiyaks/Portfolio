...
const Projects = () => {
  const projects = [
    ...
    {
      title: 'DEXTERX AI',
      description: 'Multimodal, real-time AI investigation platform for law enforcement and first responders, enabling rapid forensic analysis and evidence triage.',
      technologies: ['Python', 'Multimodal AI', 'Computer Vision', 'NLP'],
      status: 'INTERNSHIP',
      statusColor: 'bg-blue-50 text-blue-700 border-blue-200',
      role: 'Full-Stack',
      team: 'Team of 4',
      type: 'Forensic AI',
      image: '/images/DEXTERX-AI.png',
      link: 'https://github.com/adithiyaks/DEXTERX-AI.git',
    },
    {
    ...
    {
      title: 'ResQNet',
      description: 'AI-powered rescue route optimization system for disaster management using thermal imaging, CSI technology, and intelligent routing to support faster emergency response.',
      technologies: ['Python', 'AI/ML', 'Route Optimization', 'GIS'],
      status: 'AWARD WINNING',
      statusColor: 'bg-emerald-50 text-emerald-700 border-emerald-200',
      role: 'Full-Stack',
      team: 'Team of 4',
      type: 'DisasterTech AI',
      image: '/images/ResQnet.png',
      link: 'https://github.com/faheem-1404/RESQNET.git',
    },
    {
    ...
    {
      title: 'GlucoSense',
      description: 'AI-powered non-invasive glucose monitoring system combining NIR spectroscopy with multi-sensor fusion for real-time, context-aware glucose estimation.',
      technologies: ['Python', 'NIR Spectroscopy', 'Sensor Fusion', 'AI/ML', 'Patent'],
      status: 'IN DEVELOPMENT',
      statusColor: 'bg-rose-50 text-rose-700 border-rose-200',
      role: 'Full-Stack',
      team: 'Team of 3',
      type: 'MedTech AI',
      image: '/images/Glucosense.png',
      link: 'https://github.com/adithiyaks/glucosense.git',
    },
    {
